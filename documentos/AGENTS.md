...
| doc                                                                                                              | conteúdo                                                                |
| ---------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `./SERVICE-PROMPT-INICIO.md`                                                                            | a spec-mãe do produto (79 seções) � fonte de verdade de requisitos      |
| `./DECISIONS.md`                                                                                        | registro de decisões arquiteturais (ADR-001+) � NÒO edite ADRs antigos  |
...
Milestones concluídos e testados no banco real: **M0 a M8** (arquitetura, auth,
...
disputas). Ver `ROADMAP.md` para o que falta (M9: Premium/PRO/referral;
