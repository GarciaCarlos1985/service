...
| `documentos/SERVICE-PROMPT-INICIO.md` | master build spec (fonte de verdade do produto) |
| `documentos/DECISIONS.md` | registro de ADRs (adaptado 2026-08-12) |
...
- `documentos/SERVICE-PROMPT-INICIO.md` — fonte de verdade do produto.
- `documentos/DECISIONS.md` — 20 ADRs adaptados ao domínio.
