...
- [x] Auditoria do projeto (greenfield) � `./AUDITORIA_2026-08-12.md`
...
- [x] **Aplicar migrations no Supabase** � �S& aplicadas em 2026-08-13 (5 correções: `make_interval`� `ends_at` em índice; `unique` parcial� índice)
- [x] Rodar `supabase/tests/rls-security.sql` � �S& automatizado: `node scripts/sql-tests.mjs` (15/15 verdes)
