...
import { Avatar, Badge, Button, Card, CardBody, useToast } from '~/modules/ui'
...
export const Route = createFileRoute('/profissionais/$citySlug/$profileSlug')({
  loader: async ({ params }) => {
    ...
    try {
      ...
      // Banco ainda não migrado/indisponível — perfil exibe estado de erro.
...
function ProfessionalProfilePage() {
  ...
  const isProfessionalUser = user?.id === professional.id
                      ...
                      <CardBody className="flex items-center justify-between gap-4">
                        ...
                        <div className="shrink-0 text-right">
                          ...
                          <Button
                            ...
                            className="mt-2"
                            disabled
                            title="Agendamento disponível em breve"
                          >
                            Agendar
                          </Button>
                        </div>
